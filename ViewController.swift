...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        exc1.text = defaults.string(forKey: "excuse1") ?? "Final excuse"
        exc2.text = defaults.string(forKey: "excuse2") ?? "will go here!"
    ...
    @IBAction func generateExcusePressed(_ sender: Any) {
        ...
        switch easteregg {
        case 1:
            exc2.text = "Final excuse"
        case 2:
            exc2.text = "I have to defeat a gay vampire in egypt"
        default:
            break
        }
